...
import { ModuloDashboardHumorComponent } from '../../estruturas/modulo-dashboard-humor/modulo-dashboard-humor.component';
import { ModuloTop3Component } from '../../estruturas/modulo-top3/modulo-top3.component';
...
@Component({
  ...
  standalone: true,
  imports: [SplitButtonModule, ToastModule, ModuloDashboardHumorComponent, ModuloTop3Component, ButtonModule, TableModule],
...
ngOnInit() {
    this.productService.getProductsMini().then((data) => {
      console.log('Dados carregados:', data); // Verifique no console
      this.products = data;
  });
}
  ...
  constructor(private messageService: MessageService, private productService: ProductService) {
    this.items = [
        ...
        { label: 'Criar Gestor', routerLink: ['/fileupload'] }
...
listaDeEquipes = [
  { nome: 'Equipe de Desenvolvimento 01', cor: 'orange' },
  { nome: 'Equipe de Desenvolvimento 02', cor: 'red' },
  { nome: 'Equipe de Desenvolvimento 03', cor: 'orange' }
];
}
...
@Injectable({
  providedIn: 'root' // Isso disponibiliza o serviço para toda a aplicação
})
export class ProductService {
    ...
    getProductsMini() {
        return Promise.resolve(this.getProductsData().slice(0, 3)); // Agora retorna todos os produtos
    }
