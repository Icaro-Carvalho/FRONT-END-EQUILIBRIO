...
import { ModuloGestaoHumorComponent } from '../../estruturas/modulo-gestao-humor/modulo-gestao-humor.component';
...
@Component({
  selector: 'app-gestao-bem-estar',
  standalone: true,
  imports: [FormsModule, CommonModule, ModuloGestaoHumorComponent, SelectModule, TableModule],
  templateUrl: './gestao-bem-estar.component.html',
  styleUrl: './gestao-bem-estar.component.css'
})
export class GestaoBemEstarComponent {

  products!: Product[];

  activeButton: string = 'equipes';
...
export class ProductService {
    ...
    getProductsMini() {
        return Promise.resolve(this.getProductsData()); // Agora retorna todos os produtos
    }
