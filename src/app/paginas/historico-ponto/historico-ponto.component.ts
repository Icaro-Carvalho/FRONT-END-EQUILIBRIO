...
@Component({
  ...
  standalone: true,
  imports: [TableModule, CommonModule, FormsModule, ButtonModule, DatePickerModule, InputTextModule, SelectModule, PaginatorModule, DialogModule, ChartModule],
  templateUrl: './historico-ponto.component.html',
  styleUrl: './historico-ponto.component.css'
})
export class HistoricoPontoComponent implements OnInit {
